...
$route['packing-list-folding'] = 'beranda/pkglist2';
$route['packing-list-retur'] = 'beranda/pkglist3';
$route['packing-list-retur-proses'] = 'beranda/prosesretur';
...
$route['data-roll2'] = 'data/rollkain';
$route['data-roll'] = 'data/rollkain2';
...
$route['nota-update'] = 'stok/cronnotappn';
...
$route['manager'] = 'alldashboard';
$route['stok-on-rjs'] = 'alldashboard/stokonrjs';
...
$route['stok-on-pusatex/(:any)'] = 'alldashboard/stokallpusatex';
...
$route['show-piutang'] = 'alldashboard/halamanpiutang';
/*
| -------------------------------------------------------------------------
